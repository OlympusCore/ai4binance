...
`Docs/CONTINUOUS_SKILL_DISCOVERY.md`. It may scout public repositories, filter
...
`skill-staging/continuous-discovery/`.
...
`skill-staging/continuous-discovery/_admit/<skill-name>/`. The
