...
from ai4binance.research.backtesting.engine import BacktestEngine
from ai4binance.research.backtesting.liquidity import (
    LiquidityStressConfig,
    assess_liquidity_fill,
)
from ai4binance.research.backtesting.models import BacktestConfig, BacktestIntent
...
def test_backtest_records_partial_entry_fill() -> None:
    ...
    assert any(
        event["event_type"] == "ENTRY_PARTIALLY_FILLED" for event in result.audit_events
    )
