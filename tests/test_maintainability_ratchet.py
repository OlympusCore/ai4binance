...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "limits must cover governed rules",
        ),
        (
            '{"schema_version": 1, "limits": '
            '{"C901": 0, "PLR0912": 0, "PLR0915": -1}, '
            '"approved_paths": []}',
            "limits must be non-negative integers",
        ),
        (
            '{"schema_version": 1, "limits": '
            '{"C901": 0, "PLR0912": 0, "PLR0915": 0}, '
            '"approved_paths": ["outside.py"]}',
            "approved_paths must be sorted source paths",
        ),
    ],
)
