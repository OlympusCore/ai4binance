...
class ContinuousMarketHistory:
            ...
            *,
            ...
            with progress_lock:
                ...
                self._write_collection_progress(
                    ...
                    selected_assets=universe.selected_assets,
                    wallet_assets=universe.wallet_assets,
                    market_cap_assets=universe.market_cap_assets,
    ...
    def _write_collection_progress(
        ...
        *,
        ...
        universe_retention: Mapping[str, object] | None,
        ...
        _save(
            self.history.state_path,
            {
                ...
                "wallet_assets": list(wallet_assets),
                "market_cap_assets": list(market_cap_assets),
                "universe_retention": universe_retention,
                "completed_symbols": completed_symbols,
                "total_symbols": total_symbols,
                "completed_streams": completed_streams,
                "total_streams": total_streams,
