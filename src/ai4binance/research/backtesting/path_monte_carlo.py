...
from ai4binance.research.backtesting.models import BacktestConfig
...
class CandlePathMonteCarloReport:
    ...
    runtime_economics_review: BacktestRuntimeEconomicsReview | None = None
    ...
    def analyze(
        ...
        *,
        ...
        return CandlePathMonteCarloReport(
            ...
            runtime_economics_review=self.runtime_economics_review,
        )
