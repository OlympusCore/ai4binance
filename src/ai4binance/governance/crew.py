...
from ai4binance.governance.framework import CANONICAL_DEFAULT_TIMEFRAMES
...
def _engine_bindings(symbol: str) -> tuple[EngineBinding, ...]:
    return (
        EngineBinding(
            ...
            output_artifacts=("runtime/logs/crew_core_events.jsonl",),
        ),
        EngineBinding(
            "rag_second_brain",
            "local_rag_index",
            ...
            output_artifacts=("runtime/state/second-brain-index.json",),
        ),
        EngineBinding(
            "local_llm_advisory",
            "local_llm_llama_cpp",
            ...
            CrewAuthority.RESEARCH_ONLY,
            loopback_only=True,
            input_artifacts=("runtime/state/second-brain-index.json",),
            output_artifacts=("runtime/logs/local_llm_advisory_events.jsonl",),
        ),
        EngineBinding(
            "validation_pipeline",
            ...
            CrewAuthority.RESEARCH_ONLY,
            loopback_only=True,
            input_artifacts=("runtime/data/market",),
            output_artifacts=(
                f"runtime/artifacts/research/backtest/validation/{symbol}",
            ),
        ),
    )
...
def _crew_tasks(
    ...
    return (
        CrewTaskDefinition(
            ...
            ("runtime/state/second-brain-index.json",),
            CrewAuthority.READ_ONLY,
        ),
        CrewTaskDefinition(
            ...
            ("runtime/logs/market_outlook_crew_events.jsonl",),
            CrewAuthority.RESEARCH_ONLY,
        ...
        CrewTaskDefinition(
            ...
            ("runtime/logs/technical_governance_events.jsonl",),
            CrewAuthority.RESEARCH_ONLY,
            emits_signal_opportunity=True,
        ),
        CrewTaskDefinition(
            ...
            timeframes,
            ("runtime/artifacts/decisions/market_outlook/state.json",),
            ("runtime/logs/trend_detection_events.jsonl",),
            CrewAuthority.RESEARCH_ONLY,
        ),
        CrewTaskDefinition(
            ...
            timeframes,
            ("runtime/artifacts/decisions/market_outlook/state.json",),
            ("runtime/logs/support_resistance_events.jsonl",),
            CrewAuthority.RESEARCH_ONLY,
        ),
        CrewTaskDefinition(
            "price_action_review",
            ...
            ("runtime/logs/price_action_events.jsonl",),
            CrewAuthority.RESEARCH_ONLY,
        ),
        CrewTaskDefinition(
            ...
            ("runtime/logs/strategy_candidate_events.jsonl",),
            CrewAuthority.RESEARCH_ONLY,
        ),
        CrewTaskDefinition(
            validation_task_id,
        ...
        CrewTaskDefinition(
            ...
            (f"runtime/artifacts/research/backtest/validation/{symbol}",),
            (
                "runtime/state/learning_summary.json",
                "runtime/logs/learning_events.jsonl",
            ),
            CrewAuthority.RESEARCH_ONLY,
        ),
        CrewTaskDefinition(
            ...
            ("runtime/logs/portfolio_proposal_events.jsonl",),
            CrewAuthority.PAPER_PROPOSAL,
        ...
        CrewTaskDefinition(
            ...
            ("runtime/logs/risk_gatekeeper_events.jsonl",),
            CrewAuthority.RESEARCH_ONLY,
        ...
        CrewTaskDefinition(
            ...
            ("runtime/logs/local_llm_advisory_events.jsonl",),
            CrewAuthority.RESEARCH_ONLY,
