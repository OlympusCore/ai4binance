---
document_id: AI4B-BINANCE-IFC-104
title: Binance WebSocket API Market Data Reference
...
authority_scope: binance_websocket_api_market_data
content_role: DERIVED
source_of_truth: false
canonical_path: docs/contracts/interface_contract_binance_websocket_api_market_data.md
machine_enforceable: false
audit_required: true
classification: INTERNAL
---
# Binance WebSocket API Market Data Reference

## ELI10

This document keeps public market-data request formats in a bounded file.

## Source Lineage

- Source file: `docs/contracts/interface_contract_binance_websocket_api_reference.md`
- Source section start: `## Market data requests`
...
* [`<symbol>@depth<levels>`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#partial-book-depth-streams)
* [`<symbol>@depth`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#diff-depth-stream)

You can use `depth` request together with `<symbol>@depth` streams to [maintain a local order book](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#how-to-manage-a-local-order-book-correctly).
...
* [`<symbol>@trade`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#trade-streams)
...
* [`<symbol>@aggTrade`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#aggregate-trade-streams)
...
* [`<symbol>@kline_<interval>`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#klinecandlestick-streams-for-utc)
...
* [`<symbol>@ticker`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#individual-symbol-ticker-streams)
* [`<symbol>@miniTicker`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#individual-symbol-mini-ticker-stream) or [`!miniTicker@arr`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#all-market-mini-tickers-stream)
...
* [`<symbol>@ticker_<window_size>`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#individual-symbol-rolling-window-statistics-streams) or [`!ticker_<window-size>@arr`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#all-market-rolling-window-statistics-streams)
...
* [`<symbol>@bookTicker`](https://developers.binance.com/docs/binance-spot-api-docs/web-socket-streams.md#individual-symbol-book-ticker-streams)
