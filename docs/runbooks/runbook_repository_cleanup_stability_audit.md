---
document_id: AI4B-REPO-RUN-002
title: AI4BINANCE Repository Cleanup and Stability Audit
...
authority_scope: repository_cleanup_stability_audit
authority_effect: OPERATIONAL_SPECIALIZATION
content_role: AUTHORITATIVE
source_of_truth: true
source_of_truth_scope: repository_cleanup_stability_audit_runbook
machine_enforceable: true
audit_required: true
classification: INTERNAL
canonical_path: docs/runbooks/runbook_repository_cleanup_stability_audit.md
---
...
This document explains the safe control flow for repository cleanup. First, only the report is prepared;
source code, secret files, evidence, wallet status, and live settings are not changed without explicit approval.
...
- Keep local machine profile details behind the `docs/archive/local_computer_profile_reference.md` boundary.
...
- `C:\vscode-projects\ai4binance` is the canonical working tree.
- Any alternate path that resolves to `C:\vscode-projects\ai4binance` must be
  treated as the same repository root, not as a duplicate repository.
