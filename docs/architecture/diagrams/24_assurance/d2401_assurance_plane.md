---
document_id: AI4B-ARCH-DIAG-D2401-001
title: Assurance Plane
document_type: REFERENCE
version: 1.0.0
status: ACTIVE
owner: Trust and Assurance Governance
...
canonical_path: docs/architecture/diagrams/24_assurance/d2401_assurance_plane.md
...
| --- | --- |
| Diagram level | `L1` |
| Architecture family | `D2400 — ASSURANCE / COMPLIANCE` |
...
Document the repository-grounded `Assurance Plane` boundary and its relationship to the deterministic, fail-closed architecture.
...
- `src/ai4binance/ops/continuous_assurance.py`

## 6. Diagram

```mermaid
flowchart LR
 A[Governed System State] --> B[Control Assessment]
 B --> C[Policy]
 B --> D[Security]
 B --> E[Data and Evidence]
 B --> F[AI and Model]
 C --> G[Assurance Pack]
 D --> G
 E --> G
 F --> G
 G -->|gap| H[RUNNING_WITH_BLOCKERS]
```
