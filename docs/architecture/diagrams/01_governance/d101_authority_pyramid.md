---
document_id: AI4B-ARCH-DIAG-101
title: Authority Pyramid
...
canonical_path: docs/architecture/diagrams/01_governance/d101_authority_pyramid.md
...
| --- | --- |
| Diagram level | `L1` |
| Architecture family | `D100 — GOVERNANCE & AUTHORITY` |
...
Document the repository-grounded `Authority Pyramid` boundary and its relationship to the deterministic, fail-closed architecture.
...
```mermaid
flowchart TB
 A[External Constraints] --> B[Core Constitution] --> C[Governance and Compliance] --> D[Contracts and Schemas] --> E[Standards and Controls] --> F[Registries and Architecture] --> G[Workflows and Providers] --> H[Code and Configuration] --> I[Tests and Evidence] --> J[Runtime]
 K[Human Governance] -. consequential authority .-> C
```
...
- [D104 — Governance Control Plane](d104_governance_control_plane.md)
