---
document_id: AI4B-ARCH-DIAG-D1802-001
...
canonical_path: docs/architecture/diagrams/18_research/d1802_experiment_lifecycle.md
...
| --- | --- |
| Diagram level | `L4` |
| Architecture family | `D1800 — RESEARCH / BACKTEST / EXPERIMENT` |
...
Document the repository-grounded `Experiment Lifecycle` boundary and its relationship to the deterministic, fail-closed architecture.
...
stateDiagram-v2
 [*] --> DRAFT
 DRAFT --> DATASET_BOUND: provenance
 DATASET_BOUND --> BACKTESTED: integrity
 BACKTESTED --> WF_VALIDATED
 WF_VALIDATED --> OOS_VALIDATED
 OOS_VALIDATED --> ROBUSTNESS_REVIEWED
 ROBUSTNESS_REVIEWED --> PAPER_CANDIDATE
 BACKTESTED --> QUARANTINED: leakage or overfit
```
