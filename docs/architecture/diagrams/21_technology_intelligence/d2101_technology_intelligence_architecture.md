---
document_id: AI4B-ARCH-DIAG-D2101-001
...
canonical_path: docs/architecture/diagrams/21_technology_intelligence/d2101_technology_intelligence_architecture.md
...
| --- | --- |
| Diagram level | `L1` |
| Architecture family | `D2100 — TECHNOLOGY INTELLIGENCE` |
...
Document the repository-grounded `Technology Intelligence Architecture` boundary and its relationship to the deterministic, fail-closed architecture.
...
- `docs/workflows/instruction_technology_intelligence_analyzer.md`
...
```mermaid
flowchart LR
 A[Verified Sources] --> B[Research Intake] --> C[Claims and Evidence] --> D[Architecture Fit] --> E[Technology Risk] --> F[Experiment Proposal] --> G[Governance Review]
 G -->|approved research| H[Bounded Experiment]
 G -->|insufficient| I[REJECT / WATCH]
```
