...
> **Belge türü — ELI5:** Bu dosya sistemin anayasası ve hedef sözleşmesidir.
> Burada bir özelliğin yazması, o özelliğin tamamlandığı anlamına gelmez. Güncel
> durum için `README.md`, `Docs/ROADMAP.md` ve `Docs/COMPLIANCE_MATRIX.md` okunur.

## MULTI-AGENT CRYPTO ALGORITHMIC TRADING PLATFORM

### CODEX / AGENTS AI MASTER CUSTOM INSTRUCTIONS

Respond in Turkish unless source code identifiers, schemas, technical documentation, CLI commands, logs, APIs, or library conventions require English.
...
* produce MARKET, WAIT_FOR_RETEST, HOLD, SELL, BUY or NO_TRADE decisions,
...
B:
  ...
  execution: normally WAIT_FOR_RETEST or PAPER_ONLY
...
4. Eklenen veya Güncellenen Agentlar
5. Karar Akışı
6. Testler
