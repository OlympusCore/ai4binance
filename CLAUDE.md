...
# AI4BINANCE Claude Provider Adapter Instructions

## ELI10

This file points Claude-based development workflows back to the repository
operating contract. It does not define separate trading, safety, or governance
authority.

## Operating Contract

Claude workflows must follow `AGENTS.md` and the governed knowledge under
